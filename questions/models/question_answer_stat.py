...
class QuestionAnswerStat(models.Model):
    ...
    question = models.ForeignKey('questions.Question', related_name='question_stats', on_delete=models.CASCADE)
    user = models.ForeignKey('users.User', related_name='question_answer_stat_user', on_delete=models.CASCADE)
    test_unique = models.ForeignKey('tests.TestUnique', related_name='test_unique_stats', on_delete=models.CASCADE)
    question_answer = models.ForeignKey('questions.QuestionAnswer', related_name='stats', on_delete=models.CASCADE)
