...
class QuestionPostSerializer(serializers.ModelSerializer):
    ...
    edu_category_id = serializers.IntegerField()

    class Meta:
        model = Question
        fields = ('id', 'name', 'level', 'question_start_type', 'question_start_value', 'question_answer_type',
                  'question_answer_value', 'question_pattern', 'active', 'question_answers', 'components',
                  'publisher', 'publishers', 'edu_category_id', 'exams', 'changes', 'seconds')
